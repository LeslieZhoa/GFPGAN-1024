...
from trainer.GFPTrainer import GFPTrainer
import torch.distributed as dist 
from utils.utils import setup_seed,get_data_loader,merge_args
from model.config import Params as GFPParams

# torch.multiprocessing.set_start_method('spawn')

parser = argparse.ArgumentParser(description="GFPGAN")
#---------train set-------------------------------------
...
parser.add_argument('--test_interval',default=500,type=int,help='Test and save every [test_intervaal] epochs')
